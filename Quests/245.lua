...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 24501);
	Saga.AddStep(cid, QuestID, 24502);
	Saga.AddStep(cid, QuestID, 24503);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 24501 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 24502 then
		ret = QUEST_STEP_2(cid, StepID);
	elseif CurStepID == 24503 then
