...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 24301);
	Saga.AddStep(cid, QuestID, 24302);
	Saga.AddStep(cid, QuestID, 24303);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 24301 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 24302 then
		ret = QUEST_STEP_2(cid, StepID);
	elseif CurStepID == 24303 then
