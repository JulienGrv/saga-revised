...
function QUEST_START(cid)
	...
	Saga.AddStep(cid, QuestID, 25701);
	Saga.AddStep(cid, QuestID, 25702);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 25701 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 25702 then
