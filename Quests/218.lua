...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 21801);
	Saga.AddStep(cid, QuestID, 21802);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 21801 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 21802 then
