...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 20601);
	Saga.AddStep(cid, QuestID, 20602);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 20601 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 20602 then
