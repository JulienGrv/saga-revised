...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 20301);
	Saga.AddStep(cid, QuestID, 20302);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 20301 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 20302 then
