...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 23501);
	Saga.AddStep(cid, QuestID, 23502);
	Saga.AddStep(cid, QuestID, 23503);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 23501 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 23502 then
		ret = QUEST_STEP_2(cid, StepID);
	elseif CurStepID == 23503 then
