...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 16801);
	Saga.AddStep(cid, QuestID, 16802);
	Saga.AddStep(cid, QuestID, 16803);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 16801 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 16802 then
		ret = QUEST_STEP_2(cid, StepID);
	elseif CurStepID == 16803 then
