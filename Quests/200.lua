...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 20001);
	Saga.AddStep(cid, QuestID, 20002);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 20001 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 20002 then
