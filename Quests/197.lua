...
function QUEST_START(cid)
	Saga.AddStep(cid, QuestID, 19701);
	Saga.AddStep(cid, QuestID, 19702);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 19701 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 19702 then
