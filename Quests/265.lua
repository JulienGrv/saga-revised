...
function QUEST_START(cid)
	...
	Saga.AddStep(cid, QuestID, 26501);
	Saga.AddStep(cid, QuestID, 26502);
	Saga.AddStep(cid, QuestID, 26503);
	Saga.AddStep(cid, QuestID, 26504);
...
function QUEST_CHECK(cid)
	...
	if CurStepID == 26501 then
		ret = QUEST_STEP_1(cid, StepID);
	elseif CurStepID == 26502 then
		ret = QUEST_STEP_2(cid, StepID);
	elseif CurStepID == 26503 then
		ret = QUEST_STEP_3(cid, StepID);
	elseif CurStepID == 26504 then
