    ...
    public class ScenarioLuaQuest : QuestBase, IDeserializationCallback, IDisposable, ISceneraioQuest
    {
        ...
        public override int OnStart(uint cid)
        {
            ...
            catch (LuaException e)
            {
                ...
                __dbtracelog.WriteError("quest", "Missing: function QUEST_START, on Quests/{0}.xml", this.QuestId);
        ...
        public override int OnFinish(uint cid)
        {
            ...
            catch (LuaException e)
            {
                ...
                __dbtracelog.WriteError("quest", "Missing: function QUEST_FINISH, on Quests/{0}.xml", this.QuestId);
                if (__dbtracelog.TraceVerbose)
                    Console.WriteLine("Error in quest {0}, see tracelog", this.QuestId);
                return -1;
            }
        ...
        public override int OnCancel(uint cid)
        {
            ...
            catch (LuaException e)
            {
                ...
                __dbtracelog.WriteError("quest", "Missing: function QUEST_CANCEL, on Quests/{0}.xml", this.QuestId);
                if (__dbtracelog.TraceVerbose)
                    Console.WriteLine("Error in quest {0}, see tracelog", this.QuestId);
                return -1;
            }
        ...
        public override int OnVerify(uint cid)
        {
            ...
            catch (LuaException e)
            {
                ...
                __dbtracelog.WriteError("quest", "Missing: function QUEST_VERIFY, on Quests/{0}.xml", this.QuestId);
                if (__dbtracelog.TraceVerbose)
                    Console.WriteLine("Error in quest {0}, see tracelog", this.QuestId);
                return -1;
            }
        ...
        public override int OnCheckQuest(uint cid)
        {
            ...
            catch (LuaException e)
            {
                ...
                __dbtracelog.WriteError("quest", "Missing: function QUEST_CHECK, on Quests/{0}.xml", this.QuestId);
                if (__dbtracelog.TraceVerbose)
                    Console.WriteLine("Error in quest {0}, see tracelog", this.QuestId);
                return -1;
            }
